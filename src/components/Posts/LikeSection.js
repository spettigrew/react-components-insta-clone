...
const LikeSection = props => {
  ...
  const { likePost, numberOfLikes, addComment, text, handleCommentChange, post } = props;
    ...
    <div>
      ...
      >
        <div className='like-section-wrapper'>
          <FontAwesomeIcon icon={faHeart} onClick={() => addComment(post.id)} likePost={likePost}/>
        </div>
        <div className='like-section-wrapper'>
          <FontAwesomeIcon icon={faComment}/>
        </div>
        <div className='like-section-wrapper'>
          <input value={text} onChange={handleCommentChange} />
